...
export const APP_CONSTANTS = {
  ...
  CREATE: {
    ...
    guideQuestionTitle: 'Let’s start with the basics! Share a brief description of your idea, covering',
    followingQuestionTitle: 'You can provide your response in one of the following ways',
    ...
    delete: 'Delete',
    add: 'Add',
    finalContent: 'This is not the final content until you confirm it. Generated by AI.',
    additional: 'Additional fields',
    submit: 'Submit',
    review: 'Please review your idea',
    reviewDetail: 'Before submitting, please review the details you’ve provided and the fields we’ve auto-filled. Make sure everything looks correct and complete.',
    CANCEL: 'Cancel',
    edit: 'Let me edit',
    langForChat: 'en_US',
    sorryNetworkText: 'Sorry for trouble,there is some network issues please try again',
